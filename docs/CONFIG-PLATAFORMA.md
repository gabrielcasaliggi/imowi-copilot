...
3. **Clientes (BillTrack)** — Postgres **externo de solo lectura** para que el bot consulte el padrón de clientes y valide acciones. Independiente del Data Estate. Botón “Probar conexión BillTrack”.
