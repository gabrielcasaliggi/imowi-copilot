...
_CONTRACT_META: dict[str, dict[str, Any]] = {
    ...
    "show_invoice": {
        ...
        "side_effect": "READ_ONLY",
        "allowed_channels": _N1_CHANNELS | frozenset({"mobile"}),
        "preconditions": ("identity=trusted", "client_number"),
        "postconditions": (
            "ActionResult.success|empty|unavailable|denied",
            "type=FC only",
            "amount=api_invoice.amount",
            "no_currency_inference",
            "no_due_date",
            "no_mutation",
        ),
        "idempotency_strategy": "SAFE",
    ...
    "service_list": {
        ...
        "preconditions": ("identity=trusted", "client_number"),
        "postconditions": (
            "ActionResult.success|empty|unavailable|denied|needs_input",
            "source=evaluar_servicios_portal",
            "active=commercial_only",
            "no_technical_status",
            "no_selection_mutation",
            "no_mutation",
        ),
        "idempotency_strategy": "SAFE",
        "notes": "Eko 2.2A; catálogo comercial; no connectivity/selection/EFFECT",
    },
    "installation_status": {
        "domain": "services",
        "type": "READ",
        ...
        "side_effect": "READ_ONLY",
        "allowed_channels": _N1_CHANNELS | frozenset({"mobile"}),
        "preconditions": ("identity=trusted",),
        "postconditions": (
        ...
        "idempotency_strategy": "SAFE",
        "notes": (
            "Eko 2.2D Discovery: UNAVAILABLE — sin agenda/órdenes estructuradas; "
            "honest unavailable only; no EFFECT"
        ),
    },
    "show_ticket": {
        "domain": "support",
    ...
    "update_ticket": {
        ...
        "postconditions": ("evidencia_appended", "no_foreign_ticket", "no_customer_event"),
    ...
    "ticket_customer_note": {
        ...
        "idempotency_strategy": "PROTECTED: same detalle → same Event",
        "notes": "2.6I: N1 wired via journeys/canal; ENABLED + ACTIONS; agent API shares emit",
    },
    "escalate_human": {
        "domain": "support",
        "type": "ESCALATION",
