...
def system_prompt_eco_rewrite_tramite() -> str:
    ...
    return (
        ...
        "- No agregues requisitos que el borrador no pide (DNI, nota, fibra, ADSL, Plantel).\n"
        ...
        "- Si el socio eligió un producto (p.ej. Sensa o móvil), no hables de fibra, "
        "ADSL ni retiro de equipo de acceso.\n"
        "- No vuelvas a saludar con «Hola» si el hilo ya está en curso.\n"
