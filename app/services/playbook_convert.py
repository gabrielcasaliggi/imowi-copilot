...
_ALIASES: dict[str, str] = {
    ...
    "comercial": "alta_plan",
    "baja": "baja_servicio",
    "baja_voluntaria": "baja_servicio",
    "titularidad": "cambio_titularidad",
    "cambio_de_titular": "cambio_titularidad",
    "domicilio": "cambio_domicilio",
    "mudanza": "cambio_domicilio",
    "cambio_de_domicilio": "cambio_domicilio",
