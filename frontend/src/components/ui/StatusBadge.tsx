const BOT_N1_CLS =
  "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-50/10 dark:text-emerald-300 dark:border-emerald-500/35";
...
export function StatusBadge({ value }: { value: string }) {
  const cls =
    COLORS[value] ||
    (/\(N1\)$/i.test(value) ? BOT_N1_CLS : null) ||
